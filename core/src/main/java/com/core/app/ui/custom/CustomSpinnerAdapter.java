...
public class CustomSpinnerAdapter extends ArrayAdapter<String> {
    ...
    public CustomSpinnerAdapter(Context context, boolean hint, List<String> items, OnClickListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            if (hint) {
                row = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_spinner_hint, parent, false);
                ...
                row = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_spinner_plain, parent, false);
    ...
    public View getDropDownView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (hint && position == 0) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_spinner_dropdown, parent, false);
        } else {
